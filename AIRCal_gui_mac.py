...
class Input_Frame(tk.Frame):
    def __init__(self, parent):
        ...
        label2 = tk.Label(self, text="Ihr Name wie am Dienstplan", font=("Helvetica", 12))
        ...
        file_path = tk.Label(self, text=f"Datei: nicht angegeben", font=("Helvetica", 12), bg="white")
...
class Name_Frame(tk.Frame):
    def __init__(self, parent):
        ...
        label1 = tk.Label(self, text="Name konnte nicht gefunden werden, bitte aus Liste auswählen", font=("Helvetica", 14, "bold"), fg="red")
        ...
        self.error_message = tk.Label(self, text="", font=("Helvetica", 12), fg="red")
...
class Export_Frame(tk.Frame):
        def __init__(self, parent):
            ...
            label1 = tk.Label(self, text="Bitte Daten vor Export kontrollieren", font=("Helvetica", 14, "bold"))
            label1.grid(column=0, row=0, pady=10)

            self.label2 = tk.Label(self, text="", font=("Helvetica", 12, "bold"))
...
class Shifts_Frame(tk.Frame):
        def __init__(self, parent):
            ...
            label1 = tk.Label(self, text="Es konnten nicht alle Schichten ausgelesen werden, bitte korrigieren", font=("Helvetica", 14, "bold"), fg="red")
            label1.grid(column=0, row=0, pady=10, columnspan=2)

            self.label2 = tk.Label(self, text="", font=("Helvetica", 12))
